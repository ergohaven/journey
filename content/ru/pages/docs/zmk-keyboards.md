...
Для зарядки аккумулятора устройства используйте стандартный **кабель USB-C** (идет в комплекте)
Заряжайте устройство через USB порт ПК, либо можете использовать блок питания на **5В**
