...
![фотка трекбола](images/tb-mini-v3/tb.jpg)
...
![фотка дна трекбола](images/tb-mini-v3/controls.png)
...
![Еще одна фотка трекбола, поближе](images/tb-mini-v3/buttons.jpg)
...
Трекбол, как и другие девайсы на ZMK, может быть привязан к 5 устройствам, и после привязки трекбол можно переключать между ними нажатием пары клавиш. Для подключения трекбола к дополнительным устройствам потребуется использовать *слой настроек*. Чтобы попасть на этот слой, одновременно нажмите обе клавиши трекбола два раза подряд.  

![какая-то гифка, где дважды жмакаются обе клавиши?]()
...
- Нажатие **правой клавиши** переключит на следующий профиль подключения (всего доступно 5 профилей,счет ведется начиная с 0);  
...
![Шпаргалка раскладки слоя настроек]()
